---
version: 1
slug: "src-pages-salvo-index-astro"
primary_target: "src/pages/salvo/index.astro"
related_targets: ["src/pages/index.astro","src/pages/ios.astro"]
---

## Scope and mode

Dedicated `/salvo` marketing surface in **Persuade** mode, with supporting
...
A vertical field-command dispatch with actual build evidence at every seam.
The memorable moment is the five-era arsenal crossing one battlefield while the
page keeps the same deterministic command grammar.
