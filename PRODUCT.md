...
Nintek is the public portfolio and marketing home for a collection of small,
...
- Show shipped software rather than approximations.
- Make every factual claim traceable to product behavior.
- Give each app its own character without breaking the Nintek family.
- Prefer focused, durable experiences over accounts, feeds, or engagement tricks.
- Treat performance, accessibility, and responsive behavior as part of the design.

## Accessibility & Inclusion

All public surfaces require semantic structure, keyboard-visible focus, strong text
contrast, responsive layouts, stable media dimensions, and a complete reduced-motion
experience.
