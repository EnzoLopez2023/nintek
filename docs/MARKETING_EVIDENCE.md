...
| Workshop | **Online and account-backed.** Not an installable/offline PWA; no browser background-reminder claim. | Separate native client, currently withdrawn for rework. |
